...
var wasmBinaryFile;
  wasmBinaryFile = 'web-sample-static-multithreaded.wasm';
...
var ASM_CONSTS = {
  ...
  var PThread = {unusedWorkers:[],runningWorkers:[],tlsInitFunctions:[],init:function() {
        ...
        var pthreadMainJs = locateFile('web-sample-static-multithreaded.worker.js');
...
var proxiedFunctionTable = [null,exitOnMainThread,pthreadCreateProxied,_fd_close,_fd_read,_fd_seek,_fd_write];
...
/** @type {function(...*):?} */
var _run_sample = Module["_run_sample"] = createExportWrapper("run_sample");
